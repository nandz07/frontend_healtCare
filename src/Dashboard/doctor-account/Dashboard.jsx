        ...
        <div className='grid lg:grid-cols-3 gap-[30px] lg:gap-[50px]'>
          ...
          <div className='lg:col-span-2'>
            {data.isApproved === "pending" && (
              <div className='flex p-4 mb-4 text-yellow-800 bg-yellow-50 rounded-lg'>
                <svg xmlns="http://www.w3.org/2000/svg"
                  ...
                  12C2 6.47715 6.47715 2 12 2C17.5228 2 22
                   6.47715 22 12C22 17.5228 17.5228 22 12
                    22ZM11 15V17H13V15H11ZM11 7V13H13V7H11Z">
                  </path>
                </svg>
                ...
                <div className='ml-3 text-sm font-medium'>
                  ...
                  review manually and approve within 3-working days.
                </div>
            ...
            <div>
              ...
              {tab === 'settings' && (<Profile doctorData={data} setTab={setTab} />)}
            </div>
          </div>
        </div>
      )
