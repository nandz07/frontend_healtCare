...
function Profile({ doctorData,setTab }) {
    ...
    // reusabel function for adding item
    ...
    // reuseable fucntion for delete item
    ...
    const addQualification = e => {
        ...
        addItem("qualifications", {
            ...
            endingDate: "",
            degree: "PHD",
            university: "Periyaram Medical college",
        })
    }
    ...
    const addExperience = e => {
        e.preventDefault();
        addItem("experiences", {
            startingDate: '', endingDate: '', position: 'Senior Surgeon', hospital: ''
        })
    }
    ...
    const addTimeSlot = e => {
        e.preventDefault();
        addItem("timeSlots", {
            day: 'sunday', startingTime: '10:00', endingTime: '16:30'
        })
    }
        ...
        <div>
            ...
            <form action="">
                ...
                <div className="mb-5">
                    ...
                    <input type="number" name="phone" id="" value={formData.phone} onChange={handleInputChange}
                        placeholder='Phone number' className='form__input' />
                </div>
                <div className="mb-5">
                    <p className='form__label'>Bio*</p>
                    <input type="text" name="bio" id="" value={formData.bio} onChange={handleInputChange}
                ...
                <div className="mb-5">
                    <div className="grid grid-cols-3 gap-5 mb-[30px]">
                        <div>
                            ...
                            <select name="gender" value={formData.gender} onChange={handleInputChange} id=""
                        ...
                        <div>
                            ...
                            <select name="specialization" value={formData.specialization} onChange={handleInputChange} id=""
                                className='form__input py-3.5'>
                                <option value="">Select</option>
                ...
                <div className="mb-5">
                        ...
                        <div>
                            <div className='grid grid-cols-2 gap-5'>
                                <div>
                                    ...
                                    <input type="date" name="startingDate" id="" value={item.startingDate}
                                        className='form__input' onChange={e => handleQualificationChange(e, index)} />
                                </div>
                                <div>
                                    <p className="form__label">Ending Date*</p>
                                    <input type="date" name="endingDate" id="" value={item.endingDate}
                                        className='form__input' onChange={e => handleQualificationChange(e, index)} />
                                </div>
                            </div>
                            <div className='grid grid-cols-2 gap-5 mt-5'>
                                <div>
                                    ...
                                    <input type="text" name="degree" id="" value={item.degree}
                                        className='form__input' onChange={e => handleQualificationChange(e, index)} />
                                </div>
                                <div>
                                    <p className="form__label">University*</p>
                                    <input type="text" name="university" id="" value={item.university}
                                        className='form__input' onChange={e => handleQualificationChange(e, index)} />
                                </div>
                            </div>
                    ...
                    <button onClick={addQualification} className='bg-[#000] py-2 px-5 rounded text-white'>Add Qualification</button>
                </div>
                <div className="mb-5">
                        ...
                        <div>
                            ...
                            <div className='grid grid-cols-2 gap-5 mt-5'>
                                <div>
                                    ...
                                    <input type="text" name="position" id="" value={item.position}
                                        className='form__input' onChange={e => handleExperienceChange(e, index)} />
                                </div>
                                <div>
                                    <p className="form__label">Hospital*</p>
                                    <input type="text" name="hospital" id="" value={item.hospital}
                                        className='form__input' onChange={e => handleExperienceChange(e, index)} />
                                </div>
                            </div>
                    ...
                    <button onClick={addExperience} className='bg-[#000] py-2 px-5 rounded text-white'>Add Experiences</button>
                </div>
                <div className="mb-5">
                        ...
                        <div>
                            <div className='grid grid-cols-2 md:grid-cols-4 mb-[30px] gap-5'>
                                <div>
                                    ...
                                    <select name="day" id="" value={item.day} className='form__input py-3.5'
                                ...
                                <div>
                                    ...
                                    <input type="time" name="startingTime" id="" value={item.startingTime}
                                        onChange={e => handleTimeSlot(e, index)} className='form__input' />
                                </div>
                                <div>
                                    <p className="form__label">Ending Time*</p>
                                    <input type="time" name="endingTime" id="" value={item.endingTime}
                                        onChange={e => handleTimeSlot(e, index)} className='form__input' />
                                </div>
                    ...
                    <button onClick={addTimeSlot} className='bg-[#000] py-2 px-5 rounded text-white'>Add TimeSlot</button>
                </div>

                <div className="mb-5">
                    <p className='form__label'>About*</p>
                    <textarea name="about" rows={5} value={formData.about}
                        placeholder='Write about you' className='form__input' onChange={handleInputChange}></textarea>
                </div>
