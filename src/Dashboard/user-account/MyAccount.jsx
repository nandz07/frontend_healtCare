                    ...
                    !loading && !error && <div className='grid md:grid-cols-3 gap-10'>
                        <div className="pb-[50px] px-[30px] rounded-md">
                            <div className="flex items-center justify-center">
                                <figure className="w-[100px] rounded-full border-2 border-solid border-primaryColor">
                            ...
                            <div className='text-center mt-4'>
                                ...
                                <p className='text-textColor text-[15] leading-6 font-medium'>
                                    {userData.email}
                                </p>
                                <p className='text-textColor text-[15] leading-6 font-medium'>
                                    Blood Group : <span className='ml-2 text-headingColor text-[22px] leading-8'>{userData.bloodType}</span>
                                </p>
                            </div>
