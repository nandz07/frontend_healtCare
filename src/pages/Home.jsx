...
function Home() {
  return <>
        ...
        <div className="flex flex-col lg:flex-row gap-[90px] items-center justify-between">
          ...
          <div>
            ...
            md:leading-[70px]' >
              ...
              <p className='text__para'>Lorem, ipsum dolor sit amet
                consectetur adipisicing elit. Omnis obcaecati
                temporibus nesciunt non porro magnam, cupiditate
                dolorum corrupti qui amet adipisci ipsam voluptas cum
                modi mollitia, corporis dolore quisquam odit.</p>
    ...
    <section>
      <div className="container">
        <div className="xl:w-470[px] mx-auto">
        ...
        <div className="flex items-center justify-between flex-col lg:flex-row">
          ...
          <div className="xl:w-[670px] ">
            <h2 className="heading">
              Get Virtual treatment <br /> 24/7.
            </h2>
            <ul className="pl-4">
              <li className="text__para">
                1.Scedule the Appointment directly.
              </li>
              <li className="text__para">
          ...
          <div className="relative z-10 xl:w-[770px] flex justify-end mt-[50px] lg:mt-0">
            ...
            left-0 md:bottom-[100px] md:left-5
    ...
    <section>
      <div className="container">
        <div className="xl:w-[470px] mx-auto">
          <h2 className='heading text-center'>Our great Docotrs</h2>
          <p className="text__para text-center">
