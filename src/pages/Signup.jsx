...
function Signup() {
  ...
  const handleFileInputChange = async (event) => {
    ...
    // later file have to be uploaded to cloud
  }
          ...
          <form action="" onSubmit={submitHandler}>
            ...
            <div className='mb-5 flex items-center justify-between'>
              <label className='text-headingColor font-bold text-[16px] leading-7'>
                Are you a :
                <select name="role" id="" className='text-textColor font-semibold text-[15px] leading-7 px-4 py-3
                focus:outline-none'
                  value={formData.role}
                  onChange={handleInputChange}
                >
                  <option key={1} value="patient">Patient</option>
                  <option key={2} value="doctor">Doctor</option>
                </select>
              </label>
              <label className='text-headingColor font-bold text-[16px] leading-7'>
                Gender :
